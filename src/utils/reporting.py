...
class GeoReporter:
    ...
    def _get_test_context(self, test_name, error_message):
        ...
        context_map = {
            ...
            # Packages API Tests
            "test_get_all_packages": "Getting all packages with pagination (limit, page, search filters)",
            ...
            "test_search_packages": "Searching packages with filters (search term, type, price range)",
            "test_get_all_deals": "Getting all package deals with active filters (is_active, limit)",
            "test_get_single_deal": "Getting a single deal by ID (fetches first available deal)",
            "test_authenticated_booking_group_full_payment": "Authenticated GROUP package booking with FULL PAYMENT - verifies booking appears in user bookings",
            "test_authenticated_booking_group_lockdown_payment": "Authenticated GROUP package booking with LOCKDOWN PAYMENT - verifies booking appears in user bookings", 
            "test_authenticated_booking_group_deal_price": "Authenticated GROUP package booking with DEAL PRICE - requires package with active deal",
            "test_authenticated_booking_private_future_departure": "Authenticated PRIVATE package booking with departure >30 days away - any payment type allowed",
            "test_authenticated_booking_private_within_30_days_full_payment": "Authenticated PRIVATE package booking with departure ≤30 days - MUST use FULL PAYMENT",
            "test_authenticated_booking_private_within_30_days_lockdown_fails": "Authenticated PRIVATE package booking with departure ≤30 days - LOCKDOWN PAYMENT should FAIL with 400 error",
            "test_unauthenticated_booking_group_full_payment": "UNAUTHENTICATED GROUP package booking with FULL PAYMENT - verifies user_id = null and booking NOT in user account",
            "test_unauthenticated_booking_group_lockdown_payment": "UNAUTHENTICATED GROUP package booking with LOCKDOWN PAYMENT - verifies user_id = null",
            "test_unauthenticated_booking_group_deal_price": "UNAUTHENTICATED GROUP package booking with DEAL PRICE - requires package with active deal, verifies user_id = null",
            "test_unauthenticated_booking_private_future_departure": "UNAUTHENTICATED PRIVATE package booking with departure >30 days away - verifies user_id = null",
            "test_unauthenticated_booking_private_within_30_days_full_payment": "UNAUTHENTICATED PRIVATE package booking with departure ≤30 days - MUST use FULL PAYMENT, verifies user_id = null",
            "test_get_user_booked_packages": "Getting user's booked packages with optional filters (payment_status, pagination)",
            "test_get_user_booked_packages_analytics": "Getting user's booking analytics and statistics (total bookings, total spent, etc.)",
            ...
            "test_make_payment_paystack_without_auth": "Making payment with Paystack WITHOUT authentication",
            ...
            "test_make_payment_paystack_with_auth": "Making payment with Paystack WITH authentication",
            "test_make_payment_bank_transfer_with_auth": "Making payment with Bank Transfer WITH authentication",
            ...
            "test_unverified_user_blocked_from_package_listing": "Package API security validation - unverified users blocked from package listings",
            "test_unverified_user_blocked_from_package_countries": "Package countries security - unverified users blocked from accessing countries/cities",
            "test_unverified_user_blocked_from_package_booking": "Package booking security - unverified users blocked from creating bookings",
            ...
            "test_verified_user_book_group_full_payment": "Group package booking with FULL PAYMENT - verifies booking appears in bookings list and usage tracking",
            "test_verified_user_book_group_lockdown_payment": "Group package booking with LOCKDOWN PAYMENT - verifies booking appears in bookings list and usage tracking",
            "test_verified_user_book_group_deal_price": "Group package booking with DEAL PRICE - requires package with active deal, verifies booking appears in bookings list",
            "test_verified_user_book_private_future_departure": "Private package booking with departure >30 days away - any payment type allowed, verifies booking appears in bookings list",
            "test_verified_user_book_private_within_30_days_full_payment": "Private package booking with departure ≤30 days - MUST use FULL PAYMENT, verifies booking appears in bookings list",
            "test_verified_user_book_private_within_30_days_lockdown_fails": "Private package booking with departure ≤30 days - LOCKDOWN PAYMENT should FAIL with 400 error: 'Full payment is required for departure dates within 30 days'",
            ...
            "test_package_booking_creates_complete_record": "Package booking creates complete record with all required fields (ID, booking code, user details, package info, organization)",
